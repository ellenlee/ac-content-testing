...
我們會使用一個叫 RSpec 的 Ruby 套件來進行自動化測試，由於用 RSpec 撰寫的測試擁有非常方便閱讀，且能產出客製化的測試報告，RSpec 是目前在 Ruby on Rails 社群上最受歡迎的測試框架之一。

請你在本單元內先跟著執行，有了一次實作體驗後，在下個單元起，我們會詳細解釋 RSpec 的功能。

<br>
