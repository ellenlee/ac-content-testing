...
我們會使用一個叫 RSpec 的 Ruby 套件來進行自動化測試，RSpec 是目前 Rails 社群上最受歡迎的測試框架之一。使用 RSpec 撰寫的測試程式除了方便閱讀，也能透過指令產出客製化的測試報告，讓我們對測試結果一目了然。

請你在本單元內先跟著執行，有了一次實作體驗後，下個單元起，我們會詳細解釋 RSpec 的功能。

<br>
